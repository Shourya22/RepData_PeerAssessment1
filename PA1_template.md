...
Step 6  
  ...
  We will use Mean/mode value substitutions  
...
We can see that every date has 288 data points. It means that the 8 dates have no data points at all.
...
![](PA1_template_files/figure-html/unnamed-chunk-13-3.png)<!-- -->
